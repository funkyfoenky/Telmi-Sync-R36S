const en = {
  ...
  'telmios-cardmaker-alert-message-r36s-multi': '<strong>R36S dual SD (V20)</strong>: <strong>OS-only</strong> flash on {0} (right slot):<br/>• p1 BOOT + p2 rootfs<br/>• <strong>no</strong> TELMI partition on this card<br/><br/>Next you will prepare a <strong>2nd content SD</strong> (left slot).',
  'telmios-cardmaker-alert-message-r36s-multi-other': '<strong>R36S dual SD (Other)</strong>: <strong>OS-only</strong> flash on {0} (right slot):<br/>• p1 BOOT + DTB catalog + p2 rootfs<br/>• <strong>no</strong> TELMI partition on this card<br/><br/>Pick the DTB after flash, then prepare the <strong>2nd content SD</strong>.',
