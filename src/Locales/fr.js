const fr = {
  ...
  'telmios-cardmaker-alert-message-r36s': 'Mode <strong>R36S</strong> : le <strong>disque entier</strong> de {0} sera effacé et repartitionné (GPT) :<br/>• p1 BOOT (~500&nbsp;Mo)<br/>• p2 rootfs (~1,5&nbsp;Go ext4)<br/>• p3 TELMI (FAT32, reste)<br/><br/>Flash <strong>Windows natif</strong> (sans WSL) : l\'image est téléchargée automatiquement depuis GitHub. Une élévation admin pourra être demandée. Choisissez une lettre de volume de la carte (n\'importe quelle partition du même disque).',
