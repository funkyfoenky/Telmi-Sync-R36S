const en = {
  ...
  'telmios-os-sd-hint': 'OS card detected (BOOT partition). You can choose the hardware REV. To sync Stories/Music/Games, plug the content card (TELMI label).',
  ...
  'r36s-dtb-missing': 'DTB file missing on BOOT for this REV.',
  ...
  'telmios-cardmaker-alert-message-r36s': '<strong>R36S single SD</strong>: the <strong>entire disk</strong> of {0} will be wiped and repartitioned (GPT):<br/>• p1 BOOT (~500&nbsp;MB)<br/>• p2 rootfs (~1.5&nbsp;GB ext4)<br/>• p3 TELMI (FAT32, remainder)<br/><br/><strong>Native Windows</strong> flash: image downloaded from GitHub. An admin elevation prompt may appear.',
  'telmios-cardmaker-alert-r36s-multi': 'R36S dual flash — OS SD {0}',
  'telmios-cardmaker-alert-message-r36s-multi': '<strong>R36S dual SD</strong>: <strong>OS-only</strong> flash on {0} (right slot):<br/>• p1 BOOT + p2 rootfs<br/>• <strong>no</strong> TELMI partition on this card<br/><br/>Next you will prepare a <strong>2nd content SD</strong> (left slot).',
