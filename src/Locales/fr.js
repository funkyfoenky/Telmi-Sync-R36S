const fr = {
  ...
  'telmios-cardmaker-alert-message-r36s-multi': 'Mode <strong>R36S multi SD (V20)</strong> : flash <strong>OS only</strong> sur {0} (slot droit) :<br/>• p1 BOOT + p2 rootfs<br/>• <strong>pas</strong> de partition TELMI sur cette carte<br/><br/>Ensuite vous préparerez une <strong>2ᵉ SD contenu</strong> (slot gauche).',
  'telmios-cardmaker-alert-message-r36s-multi-other': 'Mode <strong>R36S multi SD (Other)</strong> : flash <strong>OS only</strong> sur {0} (slot droit) :<br/>• p1 BOOT + catalogue DTB + p2 rootfs<br/>• <strong>pas</strong> de partition TELMI sur cette carte<br/><br/>Choisissez le DTB après flash, puis préparez la <strong>2ᵉ SD contenu</strong>.',
