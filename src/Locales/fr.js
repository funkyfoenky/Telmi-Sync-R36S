const fr = {
  ...
  'telmios-os-sd-hint': 'Carte OS détectée (partition BOOT). Vous pouvez choisir la REV matérielle. Pour synchroniser Stories/Music/Games, branchez la carte contenu (label TELMI).',
  ...
  'r36s-dtb-missing': 'Fichier DTB manquant sur BOOT pour cette REV.',
  ...
  'telmios-cardmaker-alert-message-r36s': 'Mode <strong>R36S mono SD</strong> : le <strong>disque entier</strong> de {0} sera effacé et repartitionné (GPT) :<br/>• p1 BOOT (~500&nbsp;Mo)<br/>• p2 rootfs (~1,5&nbsp;Go ext4)<br/>• p3 TELMI (FAT32, reste)<br/><br/>Flash <strong>Windows natif</strong> : l\'image est téléchargée depuis GitHub. Une élévation admin pourra être demandée.',
  'telmios-cardmaker-alert-r36s-multi': 'Flash R36S multi — SD OS {0}',
  'telmios-cardmaker-alert-message-r36s-multi': 'Mode <strong>R36S multi SD</strong> : flash <strong>OS only</strong> sur {0} (slot droit) :<br/>• p1 BOOT + p2 rootfs<br/>• <strong>pas</strong> de partition TELMI sur cette carte<br/><br/>Ensuite vous préparerez une <strong>2ᵉ SD contenu</strong> (slot gauche).',
