const en = {
  ...
  'telmios-cardmaker-sd-expand': 'Expand P3 — after Rufus flash',
  ...
  'telmios-cardmaker-sd-expand-hint': 'Leaves the OS untouched. Recreates only the TELMI partition (p3) on all remaining space. Flash the .img with Rufus first (DD write), then use this mode.',
  'telmios-cardmaker-expand': 'Expand TELMI partition (P3)',
  'telmios-cardmaker-expand-title': 'Expand TELMI (P3)',
  'telmios-cardmaker-expand-create': 'Expand P3 (after Rufus)',
  'telmios-cardmaker-expand-action': 'Expand',
  ...
  'telmios-cardmaker-alert-r36s-expand': 'Expand TELMI (P3) on {0}',
  'telmios-cardmaker-alert-message-r36s-expand': 'Partitions <strong>BOOT (p1)</strong> and <strong>root (p2)</strong> stay intact.<br/>The <strong>TELMI (p3)</strong> partition on {0} will be recreated on all remaining space and formatted FAT32 (current TELMI content will be lost).<br/><br/>Use this after flashing the .img with Rufus.',
  ...
  'r36s-expand-no-p2': 'Root partition (p2) not found. Flash the Telmi image with Rufus first (DD write of the .img), then retry P3 expand.',
  'r36s-expand-boot-unsafe': 'P3 expand aborted: BOOT/root missing or unsafe layout. Re-flash the .img with Rufus (DD mode), then retry. The OS was not formatted.',
